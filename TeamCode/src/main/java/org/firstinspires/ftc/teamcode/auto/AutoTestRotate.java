...
public class AutoTestRotate extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory tr9 = drive.trajectoryBuilder(tr8.end())
                ...
                .splineToLinearHeading(new Pose2d(P1.getX()+1.7, P1.getY()+3, P1.getHeading()), 0,
        ...
        Trajectory tr11 = drive.trajectoryBuilder(tr10.end())
                ...
                .splineToLinearHeading(new Pose2d(P1.getX()+3.5, P1.getY()+1.5, P1.getHeading()),0.3,
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL,
                                DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(37))
                .addDisplacementMarker(() -> {
        ...
        Trajectory tr15 = drive.trajectoryBuilder(tr10.end())
                ...
                .splineToLinearHeading(new Pose2d(P1.getX()+3.5, P1.getY()+0, P1.getHeading()),0.3,
                        SampleMecanumDrive.getVelocityConstraint(65, DriveConstants.MAX_ANG_VEL,
                                DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(37))
                .addDisplacementMarker(() -> {
